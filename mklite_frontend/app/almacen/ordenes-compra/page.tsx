            ...
            <div className="w-full max-w-7xl bg-gray-800 rounded-xl shadow-2xl p-8">
                ...
                <header className="mb-8 flex justify-between items-center border-b border-gray-700 pb-4">
                    <h1 className="text-3xl font-extrabold text-red-600 flex items-center">
                        <svg className="w-8 h-8 mr-3" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M17 17H7v-2h10v2zm0-4H7v-2h10v2zm0-4H7V7h10v2zm4-3v14c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2zM9 16h6v-2H9v2zM9 12h6v-2H9v2zM9 8h6V6H9v2z"></path></svg>
